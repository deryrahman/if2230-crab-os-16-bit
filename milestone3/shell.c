...
void parseInput(char* buff){
	...
	else if (buff[indexIn]=='e' && buff[indexIn+1]=='x' && buff[indexIn+2]=='e' && buff[indexIn+3]=='c' && buff[indexIn+4]=='u' && buff[indexIn+5]=='t' && buff[indexIn+6]=='e' && buff[indexIn+7]==' '){
	...
	else if (buff[indexIn]=='p' && buff[indexIn+1]=='s'){
		interrupt(0x21,10,0,0,0);
	}
	else if (buff[indexIn]=='k' && buff[indexIn+1]=='i' && buff[indexIn+2]=='l' && buff[indexIn+3]=='l'){
		indexIn = indexIn + 5;
		interrupt(0x21, 11, buff[indexIn], 0, 0);
	}
	else{
